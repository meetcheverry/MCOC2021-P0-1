import numpy as np
import scipy as sp
from scipy import matrix, single, linalg, sparse
...
f=open("Datos_dispersa_INV(A)_ens.txt","w")
...
f=open("Datos_dispersa_INV(A)_sol.txt","w")
...
plt.xticks(x1 ,xticks_txt1, rotation = 45)
plt.yticks(y1, yticks_txt1)
plt.title("Tiempo de solucion INV(A)*b")
plt.ylim([0.000001, 600])
plt.xlim([0, 10000])
#malla
plt.grid(True)
