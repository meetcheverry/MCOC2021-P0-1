...
for i in range(0,10):
    for N in nm:
        ...
        A = laplaciana_dispersa(N,double)
        b = np.ones(N)
...
f=open("Datos_Dispersa_Ens.txt","w")
...
f=open("Datos_dispersa_Sol.txt","w")
...
#grafica ensamblado
plt.subplot(2,1,1)
plt.loglog(nm,tiempo1_ens)
plt.loglog(nm,C_1,label="C")
plt.loglog(nm,N1_1,label="N")
plt.loglog(nm,N2_1,label="N2")
plt.loglog(nm,N3_1,label="N3")
plt.loglog(nm,N4_1,label="N4")
...
plt.title("Tiempo de ensamblado")
...
#grafica rendimiento
plt.subplot(2,1,2)
plt.loglog(nm,tiempo1_sol)
plt.loglog(nm,C_2,label="C")
plt.loglog(nm,N1_2,label="N")
plt.loglog(nm,N2_2,label="N2")
plt.loglog(nm,N3_2,label="N3")
plt.loglog(nm,N4_2,label="N4")
#etiqueta ejes
plt.xlabel("Dimension matriz N")
plt.ylabel("Tiempo transcurrido (s)")
#Titulo
